...
def classify_meal_types(
    ...
    breakfast_kr = ["죽", "토스트", "시리얼", "팬케이크", "오트밀", "계란", "샌드위치", "스무디", "그래놀라", "식빵", "잼"]
    lunch_kr = ["볶음밥", "비빔밥", "국수", "라면", "덮밥", "김밥", "도시락", "우동", "파스타", "샐러드", "냉면", "칼국수", "자장면", "짬뽕"]
    dinner_kr = ["스테이크", "찜", "구이", "탕", "찌개", "전골", "갈비", "불고기", "로스트", "삼겹살", "보쌈", "족발", "수육", "샤브샤브"]
    snack_kr = ["떡볶이", "떡", "쿠키", "케이크", "빵", "머핀", "와플", "디저트", "과자", "타르트", "브라우니", "마카롱", "푸딩", "아이스크림", "파전", "감자전", "해물전", "김치전", "녹두전", "호떡", "붕어빵", "튀김"]

    # English keyword matching
    breakfast_en = ["porridge", "toast", "cereal", "pancake", "oatmeal", "egg", "sandwich", "smoothie", "granola", "breakfast", "waffle", "bacon", "omelet", "omelette", "french toast", "scramble"]
    lunch_en = ["fried rice", "bibimbap", "noodle", "ramen", "rice bowl", "kimbap", "pasta", "salad", "wrap", "bowl", "soup", "sandwich", "burger", "taco", "quesadilla"]
    dinner_en = ["steak", "stew", "roast", "grill", "braised", "curry", "casserole", "lasagna", "lamb", "beef", "pork", "chicken roast", "pot roast", "ribs"]
    snack_en = ["cookie", "cake", "muffin", "waffle", "dessert", "snack", "brownie", "tart", "pie", "pudding", "ice cream", "pastry", "scone", "donut", "doughnut", "macaron", "fudge", "candy"]
